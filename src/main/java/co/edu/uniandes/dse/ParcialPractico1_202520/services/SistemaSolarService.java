...
public class SistemaSolarService {
    ...
    public SistemaSolar createSistemaSolar(SistemaSolar sistemaSolar) throws IllegalOperationException {
        ...
        if (ratio == null || ratio < 0.2 || ratio > 0.6) {
            throw new IllegalOperationException("El ratio de fuerza debe estar entre 0.2 y 0.6.");
        }
        //Regla stormtroopers > 1000
        if (sistemaSolar.getStormtroopersAsignados() == null || sistemaSolar.getStormtroopersAsignados() <= 1000) {
            throw new IllegalOperationException("El número de Stormtroopers debe ser mayor a 1000.");
        }
